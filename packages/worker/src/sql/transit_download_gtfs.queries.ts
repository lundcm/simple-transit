...
const addLocationFeedDownloadIR: any = {
  name: 'AddLocationFeedDownload',
  params: [
    {
      name: 'location_feed_id',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 286, b: 301, line: 6, col: 9 }] },
    },
    {
      name: 'download_date',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 313, b: 325, line: 7, col: 9 }] },
    },
    {
      name: 'rows_read',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 337, b: 345, line: 8, col: 9 }] },
    },
    {
      name: 'failure',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 357, b: 363, line: 9, col: 9 }] },
    },
  ],
  usedParamSet: {
    location_feed_id: true,
    download_date: true,
    rows_read: true,
    failure: true,
  },
  statement: {
    body: 'insert into app_public.location_feed_download (location_feed_id,\n                                               download_date,\n                                               rows_read,\n                                               failure)\nvalues (:location_feed_id,\n        :download_date,\n        :rows_read,\n        :failure)',
    loc: { a: 36, b: 364, line: 2, col: 0 },
  },
};
 ...
 * ```
 */
export const addLocationFeedDownload = new PreparedQuery<
  IAddLocationFeedDownloadParams,
  IAddLocationFeedDownloadResult
>(addLocationFeedDownloadIR);
...
const updateLocationFeedDownloadIR: any = {
  ...
  params: [
    {
      ...
      codeRefs: {
        used: [
          { a: 528, b: 532, line: 12, col: 81 },
          { a: 633, b: 637, line: 13, col: 78 },
        ],
      },
    },
    {
      ...
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 542, b: 546, line: 12, col: 95 }] },
    },
    {
      name: 'status',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 647, b: 652, line: 13, col: 92 }] },
    },
    {
      name: 'location_feed_id',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 687, b: 702, line: 14, col: 26 }] },
    },
    {
      name: 'download_date',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 727, b: 739, line: 15, col: 23 }] },
    },
  ],
  usedParamSet: {
    table: true,
 ...
 * ```
 */
export const updateLocationFeedDownload = new PreparedQuery<
  IUpdateLocationFeedDownloadParams,
  IUpdateLocationFeedDownloadResult
>(updateLocationFeedDownloadIR);
