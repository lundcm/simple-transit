--! Previous: -
--! Hash: sha1:d5365fb99b0bc3e8aaac50af2349d41597267c5b
...
alter table app_public.organization_invitations
    enable row level security;
...
create trigger _500_send_email
    after insert
    on app_public.organization_invitations
    for each row
execute procedure app_private.tg__add_job('organization_invitations__send_invite');
